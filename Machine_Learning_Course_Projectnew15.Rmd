...
This document is the report of the Peer Assessment project from Coursera's course Practical Machine Learning, as part of the Specialization in Data Science. It was built up in RStudio, using its knitr functions, meant to be published in html format.
...
#setwd("~/08 Practical Machine Learning/Projeto")
library(knitr)
library(rpart)
library(ggplot2)
library(rpart.plot)
