...
bigram <- readRDS(file="C:/Work/Data Science/final_bigram_sm.Rda")
trigram <- readRDS(file="C:/Work/Data Science/final_trigram_sm.Rda")
fourgram <- readRDS(file="C:/Work/Data Science/final_fourgram_sm.Rda")
...
nextWordPredictor <- function(inputTxt) {
  ...
  if(nchar(inputTxt) > 0) {
    ...
    iinputTxt <- removePunctuation(inputTxt)
